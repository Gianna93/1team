...
<div class="d-flex align-items-start">
  ...
  <div class="tab-content" id="v-pills-tabContent">
	...
	<form><br>
	<h1 class="productTitle">상품 수정</h1>
	<br><br>
		<div class="form-group">
			<label for="product_name"><b>상품명</b></label>
	...
	<button id="btn-update" class="btn btn-dark">상품수정</button>
	</div></div>
	...
	<form><br>
	<h1 class="productTitle">상품 삭제</h1>
	<br><br>
		<div class="form-group">
			<label for="product_name"><b>상품명</b></label>
			<input type="text" class="form-control" placeholder="상품명" id="product_name" name="product_name" required>
	...
	<button id="btn-delete" class="btn btn-dark">상품삭제</button>
	</div></div>
