...
<div class="d-flex align-items-start">
  <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <button class="nav-link" id="v-pills-update-tab" data-bs-toggle="pill" data-bs-target="#v-pills-update" type="button" role="tab" aria-controls="v-pills-update" aria-selected="false">상품수정</button>
     <button class="nav-link" id="v-pills-delete-tab" data-bs-toggle="pill" data-bs-target="#v-pills-delete" type="button" role="tab" aria-controls="v-pills-delete" aria-selected="false">상품삭제</button>
  </div>
  <div class="tab-content" id="v-pills-tabContent">
    ...
    <div class="tab-pane fade show" id="v-pills-update" role="tabpanel" aria-labelledby="v-pills-update-tab"><div>
	<form><br>
	<p class="myPageTitle">상품 수정</p>
	<br><br>
		<div class="form-group">
			<label for="product_name"><b>상품명</b></label>
	...
	<button id="btn-update" class="btn btn-dark" style="width:300px;">상품수정</button>
	</div></div>
	...
	<div class="tab-pane fade show" id="v-pills-delete" role="tabpanel" aria-labelledby="v-pills-delete-tab"><div>
	<form><br>
	<p class="myPageTitle">상품 삭제</p>
	<br><br>
		<div class="form-group">
			<label for="product_name"><b>상품명</b></label>
			<input type="text" class="form-control" placeholder="상품명" id="product_name" name="product_name" required>
	...
	<button id="btn-delete" class="btn btn-dark" style="width:300px;">상품삭제</button>
	</div></div>
